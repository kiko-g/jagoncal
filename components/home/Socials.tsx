...
const links = [
  {
    ...
    icon: (
      <svg
        viewBox="0 0 24 24"
        aria-hidden="true"
        className="h-6 w-6 fill-zinc-500 transition group-hover:fill-[#333] dark:fill-zinc-400 dark:group-hover:fill-white"
      >
        <path
          fillRule="evenodd"
          clipRule="evenodd"
  ...
  },
  {
    ...
    icon: (
      <svg
        viewBox="0 0 24 24"
        aria-hidden="true"
        className="h-6 w-6 fill-zinc-500 transition group-hover:fill-[#0072b1] dark:fill-zinc-400 dark:group-hover:fill-white"
      >
  ...
  },
  {
    ...
    icon: (
      <svg
        aria-hidden="true"
        viewBox="0 0 256 256"
        className="h-6 w-6 fill-zinc-500 p-[1px] transition group-hover:fill-lime-400 dark:fill-zinc-400 dark:group-hover:fill-white"
      >
  ...
  },
  {
    ...
    icon: (
      <svg
        aria-hidden="true"
        viewBox="0 0 48 48"
        className="h-6 w-6 rounded fill-zinc-500 p-[1px] transition group-hover:fill-[#2C5E90] dark:fill-zinc-400 dark:group-hover:fill-white"
      >
  ...
  {
    name: 'Ciencia Vitae',
    text: 'Visit my Ciencia Vitae page',
    url: 'https://www.cienciavitae.pt/4D14-2A3F-7528',
    icon: (
      <svg
        aria-hidden="true"
        viewBox="0 0 48 48"
        className="h-6 w-6 rounded fill-zinc-500 p-[1px] transition group-hover:fill-zinc-700 dark:fill-zinc-400 dark:group-hover:fill-white"
      >
        <g clipPath="url(#clip0_106_3)">
          ...
          >
            <path
              d="M132.808 -34.3109H-85.1963V119.835H132.808V-34.3109Z"
              fill="white"
            />
          </mask>
          <g mask="url(#mask0_106_3)">
            <path
              d="M8.56488 24.3426L16.0415 17.3423L11.9762 13.3813L0.981979 24.3957L12.0531 35.4907L16.014 31.5609"
              className="fill-zinc-500 transition group-hover:fill-[#CCDB2C] dark:fill-zinc-400 dark:group-hover:fill-white"
            />
          </g>
          <mask
            id="mask1_106_3"
          ...
          <g mask="url(#mask1_106_3)">
            <path
              d="M21.5908 24.436C21.5908 26.1893 20.171 27.6091 18.4177 27.6091C16.6644 27.6091 15.2446 26.1893 15.2446 24.436C15.2446 22.6827 16.6644 21.2629 18.4177 21.2629C20.171 21.2629 21.5908 22.6827 21.5908 24.436Z"
              className="fill-zinc-500 transition group-hover:fill-[#CCDB2C] dark:fill-zinc-400 dark:group-hover:fill-white"
            />
          </g>
          <mask
          ...
          <g mask="url(#mask2_106_3)">
            <path
              d="M35.4852 27.1585L28.4849 19.6818L24.5221 23.7472L35.5365 34.7414L46.6315 23.6684L42.7035 19.7075"
              className="fill-zinc-500 transition group-hover:fill-[#046938] dark:fill-zinc-400 dark:group-hover:fill-white"
            />
          </g>
          <mask
            id="mask3_106_3"
          ...
          <g mask="url(#mask3_106_3)">
            <path
              d="M35.5768 14.1307C37.3301 14.1307 38.7499 15.5505 38.7499 17.3038C38.7499 19.0553 37.3301 20.4769 35.5768 20.4769C33.8235 20.4769 32.4037 19.0553 32.4037 17.3038C32.4037 15.5524 33.8254 14.1307 35.5768 14.1307Z"
              className="fill-zinc-500 transition group-hover:fill-[#046938] dark:fill-zinc-400 dark:group-hover:fill-white"
            />
          </g>
        </g>
  ...
  },
  {
    ...
    icon: (
      <svg
        aria-hidden="true"
        viewBox="0 0 160 160"
        className="h-6 w-6 rounded fill-zinc-500 p-[2px] transition group-hover:fill-zinc-700 dark:fill-zinc-400 dark:group-hover:fill-white"
      >
  ...
  // break
  {
    ...
    icon: (
      <EnvelopeIcon className="h-6 w-6 text-zinc-500 transition group-hover:text-slate-800 dark:text-zinc-400 dark:group-hover:text-white" />
    ),
  },
]
