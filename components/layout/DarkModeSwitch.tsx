    ...
    <div className="pointer-events-auto">
      ...
      >
        ...
        <svg
          viewBox="0 0 24 24"
          aria-hidden="true"
          className="hidden h-6 w-6 fill-zinc-700 stroke-blue-500 transition dark:block [@media(prefers-color-scheme:dark)]:group-hover:stroke-blue-300 [@media_not_(prefers-color-scheme:dark)]:fill-blue-500/10 [@media_not_(prefers-color-scheme:dark)]:stroke-blue-600"
        >
          <path
