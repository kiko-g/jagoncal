    ...
    <div className="pointer-events-auto">
      ...
      >
        ...
        <svg
          viewBox="0 0 24 24"
          aria-hidden="true"
          className="hidden h-6 w-6 fill-zinc-700 stroke-indigo-400 transition dark:block [@media(prefers-color-scheme:dark)]:group-hover:stroke-indigo-300 [@media_not_(prefers-color-scheme:dark)]:fill-indigo-400/10 [@media_not_(prefers-color-scheme:dark)]:stroke-indigo-500"
        >
          <path
